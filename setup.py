...
setup(name='extended_nnunet',
      ...
      version='1.7.0',
      description='nnUnet_RASPP nnU-Net. Framework for out-of-the box biomedical image segmentation with added UNet models.',
      url='https://github.com/ndipenoch/nnUnet_RASPP.git',
